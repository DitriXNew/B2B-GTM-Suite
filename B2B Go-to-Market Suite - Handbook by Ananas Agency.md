# B2B Go-to-Market Suite - Handbook
...
## Skill reference materials: company-brief

### Reference: rules-company-brief.md
...
# 1. Value Propositions (PSO (Problem · Solution · Outcome))

**Skill ID:** `value-proposition`
...
## Skill reference materials: value-proposition

### Reference: rules-pso.md

# PSO (Problem · Solution · Outcome) Rules — Detailed Reference

## PSO (Problem · Solution · Outcome) sentence pattern

PSO (Problem · Solution · Outcome) stands for:
- **P (Problem)** — the concrete pain the customer feels, and what it costs them.
- **S (Solution)** — what you specifically do about it (mechanism, parameter, method).
- **O (Outcome)** — the measurable business result for the customer (EUR, %, time, units).

### Standard version
"Because **[P (Problem)]**, we offer **[S (Solution)]**, which makes it possible to **[O (Outcome)]**."

### Narrative version (preferred)
"Many of our customers [P (Problem) — description of the problem], which is why we [S (Solution) — what we do]. As a result, [O (Outcome) — business result]."

### Punchy version
"We help achieve **[O (Outcome)]** by solving **[P (Problem)]** through **[S (Solution)]**."

---

## Examples of good PSOs

**Product (packaging producer):**
"Many of our customers see whole batches rejected because the print on the packaging fades during transport, which is why we use UV-cured inks rated for 18 months of outdoor exposure. As a result, the rejection rate on shipped batches dropped from 7% to under 1%, saving them roughly €30,000 a year in scrapped product."

**Product (industrial pump supplier):**
"Many plants have to shut down a line for half a day just to swap a worn pump seal, because standard units aren't built for quick service. Our pumps use a cartridge seal that one technician replaces in 15 minutes without dismantling the housing. As a result, an unplanned stop costs 15 minutes instead of 4 hours, and at €2,000/h of downtime, that's €7,700 saved per failure."

**Service value (electronics contract manufacturer):**
"Customers are often afraid to commit to a large run before they know the design holds up in the field. That's why we produce a free 50-unit pilot batch and run it through full functional testing before mass production. As a result, design faults are caught before scale-up, and the average customer avoids one costly recall worth €60,000–120,000."

**Service value (logistics provider):**
"Many of our customers can't tell their own clients when a shipment will actually arrive, because their previous carrier only updated status once a day. That's why we give every customer a live tracking portal with GPS updates every 10 minutes and an ETA accurate to 30 minutes. As a result, their customer-service team handles 40% fewer 'where is my order' calls."

**Added (chemical distributor):**
"Many of our customers are small workshops without a compliance officer, and they struggle to keep up with changing REACH and safety-data regulations. That's why we send updated safety data sheets and regulatory alerts the moment a rule changes. As a result, the customer passes audits without scrambling and avoids fines that can reach €15,000 per violation."

**Added (CNC tooling supplier):**
"Customers often run their tools at the wrong feed and speed settings, which wears them out twice as fast and drives up cost-per-part. That's why our engineer provides a free cutting-parameter sheet tailored to each customer's material and machine. As a result, tool life increased by 60% and the customer's tooling spend dropped by about €18,000 a year."

---

## Examples of BAD values (anti-patterns)

### Empty slogans (no PSO (Problem · Solution · Outcome))
- "We have our own production facility." -> No P (Problem) and no O (Outcome). So what does that change for the customer?
- "We are a trusted partner." -> No P (Problem) and no O (Outcome). Trusted by whom, and what does that deliver?
- "We use only certified materials." -> Which certificate, and what problem does it prevent?
- "We are passionate about what we do." -> Empty. Zero information.
- "We offer competitive prices." -> Compared to whom? By how much? What does the customer gain?
- "We have years of experience." -> And what does that experience give the customer?
- "Quality is our top priority." -> Every competitor says this. Which parameter, which standard, how is it measured?
- "We put the customer first." -> A claim, not a value. What do you actually do that proves it?
- "We deliver tailor-made solutions." -> Tailored how? What problem with off-the-shelf does that fix, and what's the result?
- "We are a leader in the market." -> Leader by what metric? And what does that give the customer specifically?
- "We are a modern, dynamic company." -> Adjectives about you, nothing about the customer's problem or outcome.
- "We guarantee satisfaction." -> Guaranteed how? What happens if they're not satisfied, and what risk does that remove?

### False PSOs (no real problem or outcome)
"Customers want fast service, we are fast, so the customer gets fast service."
-> P (Problem) repeats S (Solution), O (Outcome) repeats S (Solution). Zero substance.

"Companies need an innovative partner, we are innovative, so the customer has innovation."
-> The same word three times. No specifics.

"Customers need quality, we deliver quality, so the customer has quality."
-> Circular. No real problem, no measurable outcome.

"Businesses want to save money, we are cost-effective, so the customer saves money."
-> P (Problem), S (Solution) and O (Outcome) are all the same idea restated. Save how much? Compared to what?

"Clients value reliability, we are reliable, so our clients can rely on us."
-> Restates the same word. No mechanism, no number.

### Fake problem (the "problem" is just wanting the product)
- "Customers need good packaging, so we provide good packaging." -> "Needing the product" isn't a problem. What goes *wrong* without it: rejected batches, returns, lost sales?
- "Companies want reliable suppliers, so we are a reliable supplier." -> What does unreliability actually cost them: downtime, missed deadlines, penalties?
- "Customers are looking for a partner they can trust." -> Vague desire, not a concrete pain. What bad experience are they trying to avoid?

### Outcome that benefits you, not the customer
- "increases our sales" -> That's *your* outcome. What does the customer get?
- "lets us scale faster" -> Your benefit. Reframe to the customer's saving/gain.
- "strengthens our market position" -> About you. What problem does it solve for them?
- "builds long-term relationships" -> Nice for you. What measurable result does the customer see?

### Outcome without a number (needs improvement)
- "improves energy efficiency" -> By how much? What % less power, how much per year (EUR)?
- "extends equipment lifespan" -> By how many years? From how many to how many?
- "speeds up order processing" -> By how much? From how many hours to how many?
- "reduces material waste" -> From what % to what? How much per month?

With every qualitative outcome, ask: "Can you estimate a number? E.g. % of savings, EUR, days, units?" Accept a description ONLY when the user confirms there is no number.

### Typical, banal values (reject or dig deeper)
- "wide product range" -> How many SKUs? Wider than whom? What problem does it solve?
- "customer-oriented service" -> Oriented how, specifically?
- "qualified specialists" -> Qualified in what? What certifications? What does it deliver?
- "comprehensive solutions" -> Comprehensive how? What exactly is included that others skip?
- "reliable products" -> Which parameter proves it? Which standard? How many % fewer failures?
- "innovative approach" -> What specifically is innovative, and what does it give the customer?

**Rule:** If a value sounds like a line from a marketing brochure, dig deeper or reject it.

---

## The non-obviousness rule

A list of values is worthless if it's made up only of generic values. The most valuable values are:

- **Atypical** — competitors don't offer them
- **Specific** — backed by numbers, names, parameters
- **Rare** — hard to copy

Generic values (speed, quality, flexibility) belong on the list ONLY when they're backed by specifics and numbers, e.g. "we deliver within 4h within a 100km radius" instead of "fast deliveries".

---

## Checklist of areas to review

When you're short of values to reach 20 (or hunting for more to reach 30+), work through the areas below and ask about the ones that haven't been covered:

### Product
- [ ] Technical parameters / distinguishing specification
- [ ] Material / raw material / composition — better than standard
- [ ] Durability / lifespan / reliability (MTBF, technical warranty)
- [ ] Performance / speed / precision
- [ ] Scope of the service vs the competition (what's in the package that others don't have)
- [ ] Product certifications / standards / approvals (CE, ISO, industry-specific)
- [ ] Personalization / configurability / made-to-order production
- [ ] Compatibility / integration with the customer's other systems
- [ ] Assortment / breadth of offer / variants

### Service
- [ ] Delivery time and logistics (warehouse, transport, availability)
- [ ] Logistics minimum / order size
- [ ] Ordering process (methods, convenience, repeatability)
- [ ] Response time to tickets / after-sales service / SLA
- [ ] Onboarding / implementation / go-live
- [ ] Dedicated account manager / technical advisor
- [ ] Contract terms (flexibility, termination)
- [ ] Payment terms / financing / trade credit
- [ ] Reporting and transparency
- [ ] Complaints and warranty — how fast and how smooth
- [ ] What happens after the engagement ends / offboarding / continuity

### Added
- [ ] Technical advisory / audits / solution selection
- [ ] Customer education (training, content, webinars)
- [ ] Community / networking between customers
- [ ] Partnerships and integrations that deliver extra benefits
- [ ] Brand / recognition as social proof
- [ ] Location / proximity / geographic availability
- [ ] Industry know-how that goes beyond the scope of the product/service
- [ ] References / case studies / samples
- [ ] Help with securing grants / certifications / documentation

---

## Value-extracting questions

### About the product/service
- What do you do faster than the competition?
- What do you do more accurately?
- What do you do better?
- Which of the things you do reduces the customer's risk?
- Which product parameter matters most to customers, and how do you measure up?
- What material / technology do you use, and why is it better?
- What certifications does the product carry, and what do they give the customer?
- Do you produce to order / personalize? What does that look like?

### About the service experience
- Where do you exceed the customer's expectations?
- What does the ordering / implementation process look like step by step?
- What happens when something goes wrong? How fast do you respond?
- What are customers afraid of before buying, and how do you address it?
- What are your payment / warranty / SLA terms?
- What does progress reporting look like: what does the customer get, and how often?
- What happens when the engagement ends? What does the handover look like?
- What does logistics look like: warehouse, delivery, minimum order?
- How do you handle complaints?

### About added values
- What does the customer get beyond the product/service itself?
- What do customers thank you for that they didn't expect?
- What do customers say when you ask them "why do you work with us"?
- Do you do anything that educates customers or builds their competencies?
- Do you have partnerships / integrations that give the customer extra value?
- Do you help customers with something you don't charge for?

### Number-probing (use with EVERY outcome)
- How much exactly is it? (EUR, %, days, units, hours)
- Can you give a range? (e.g. "20-30% faster")
- How does it compare numerically with the competition?
- What's the financial effect for the customer: how much do they save / earn?
- Do you have a customer example with specific numbers?

---

## Rule: it is NOT a value if...

- It doesn't solve any customer problem
- It doesn't deliver any business outcome
- Every company in the industry can say the same thing
- It can't be verified (no specifics)

When the user proposes something like this, don't reject it outright, but dig deeper: "That's interesting. And what specific customer problem does it solve? And what effect does it have on their business?"
...
### Duplicate — merge:
- "Fast delivery" + "Large warehouse ensuring availability" -> the same mechanism (warehouse) solving the same problem (the customer is waiting for goods). Merge into one value.
- "Flexible payment terms" + "Long 60-day payment term" -> one is a subset of the other. Merge.
- "24/7 technical support" + "We always pick up the phone" -> the same mechanism (round-the-clock availability) solving the same problem (the customer is stuck and can't reach anyone). Merge.
- "Free delivery" + "No extra logistics charges" -> two phrasings of the same benefit (the customer pays nothing for transport). Merge.
- "Custom-made to order" + "We adapt the product to your specs" -> the same mechanism (made-to-order production) solving the same problem (off-the-shelf doesn't fit). Merge.
- "Dedicated account manager" + "One point of contact for everything" -> the same mechanism (a single named contact) solving the same problem (the customer is bounced between departments). Merge.

### NOT a duplicate — keep separate:
- "Large warehouse -> the customer doesn't have to wait for delivery" (problem: production downtime) vs "Large warehouse -> the customer doesn't have to keep their own stock" (problem: frozen capital) -> DIFFERENT customer problems, so these are two separate values.
- "Fast response to tickets -> minimizes downtime during a breakdown" (problem: line is stopped now) vs "Preventive maintenance plan -> fewer breakdowns happen at all" (problem: failures occur in the first place) -> one is reactive, one is preventive. DIFFERENT problems, keep separate.
- "ISO certification -> the customer passes their own audits" (problem: compliance risk) vs "ISO certification -> guarantees consistent quality batch to batch" (problem: product variability) -> same mechanism, but DIFFERENT customer problems. Keep separate.
- "30-day return policy -> lowers the risk of a wrong purchase" (problem: buyer's risk before the sale) vs "Fast complaint handling -> minimizes loss when a defect appears" (problem: dealing with a defect after the sale) -> DIFFERENT stages and problems. Keep separate.

---

## Output file format

### File 1: `value-propositions.md` (Markdown — full documentation)

Structure:
```markdown
# Value Propositions — [Company name]
Date: [date]
Model: Ananas-Agency PSO

## Product Values
### PV-01. [Value title] — Score: X/20
- **Problem:** [P]
- **Solution:** [S]
- **Outcome:** [O]
- **Source:** hypothesis
> "[Complete PSO sentence]"

The ID prefix matches the category: PV- for Product value, SV- for Service value, AV- for Added value.
`Source:` is `hypothesis` until a Persona Experiment (Skill 4) tests the value; it then
becomes `validated` (or stays `hypothesis` if refuted). New values start as `hypothesis`.
...
## Summary
- Total number of values: XX
- Top 5 strongest (cross-category): [list, cited by ID]

## Competitor snapshot
Which competitors also claim each value (✓ = claims it, ✗ = doesn't, ? = unsure).
A value is `unique` only when the whole row is ✗.

| Value ID | [Competitor A] | [Competitor B] | [Competitor C] | Unique? |
|----------|----------------|----------------|----------------|---------|
| PV-01    | ✗              | ✗              | ?              | no      |
| SV-02    | ✗              | ✗              | ✗              | **yes** |
```

### File 2: `value-propositions.html` (styled, share-ready)

A single **self-contained** `.html` file (all CSS inline in one `<style>` block, **no external assets and no JavaScript**), so it opens in any browser, prints cleanly to PDF, and can be emailed as one file. Render the **same content** as the Markdown version, mapped onto the components below. Keep the `<style>` block **identical across every skill in this suite** so all deliverables share one look (this is the shared design system referenced by the other skills).

- One `<section class="block">` per category, in order: Product → Service → Added.
- One `.card` per value (the section it sits in carries the category: no per-card colour coding).
- In each card header: the `.id` chip (PV-/SV-/AV-), the score as a mini meter — `<span class="scorewrap"><span class="meter"><i style="width:NN%"></i></span><span class="scoreno">X/20</span></span>` (bar width = score/20), the `.tag-unique` chip **only** for unique values, and a **`Source` pill** — `<span class="tag validated">validated</span>` or `<span class="tag hypothesis">hypothesis</span>` (yellow = untested, green = confirmed).
- Problem / Solution / Outcome as `.row`s; the full PSO (Problem · Solution · Outcome) sentence in a `<blockquote>`.
- A **Summary block** (total count + top-5 by ID).
- Close with a **Competitor snapshot block** — a `<table>` (values × competitors, ✓/✗/? cells, Unique? column), matching the `.md` snapshot.
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>Value Propositions — [Company name]</title>
<style>
:root{--page:#f5f5f7;--paper:#ffffff;--ink:#111111;--soft:#5b5852;--line:#e2e2e7;
--brand:#d99a2b;--brand-deep:#946618;--band:#0b0b0a;--band-ink:#b8b2a4}
*{box-sizing:border-box}
...
<div class="brandband">
  <div class="bwrap">
    <a class="pkgname" href="https://b2b-gtm-suite.ananas-agency.com/?utm_source=ananas-sales-skills&amp;utm_medium=deliverable&amp;utm_campaign=b2b-gtm-suite&amp;utm_content=value-proposition" target="_blank" rel="noopener">B2B Go-to-Market Suite</a>
    <a class="brandlink" href="https://ananas-agency.com/?utm_source=ananas-sales-skills&amp;utm_medium=deliverable&amp;utm_campaign=b2b-gtm-suite&amp;utm_content=value-proposition" target="_blank" rel="noopener">
      <span class="byline">by</span>
      <img class="brandlogo" src="https://ananas-agency.com/wp-content/uploads/2025/05/ananas-agency-logo-no-background-for-black.png" alt="Ananas Agency">
    </a>
  </div>
...
<div class="wrap">
  <header class="doc">
    <h1>Value Propositions — [Company name]</h1>
    <div class="meta"><b>Date:</b> [date] &nbsp;·&nbsp; <b>Model:</b> Ananas-Agency PSO &nbsp;·&nbsp; <b>Values:</b> [XX]</div>
  </header>

  <section class="block">
    <h2 class="section">Product Values</h2>
    <article class="card product">
      <h3><span class="id">PV-01</span> [Value title]
          <span class="badge">[X]/20</span> <span class="tag-unique">unique</span>
          <span class="tag hypothesis">hypothesis</span></h3>
    ...
    <!-- further product cards -->
  </section>

  <section class="block">
    <h2 class="section">Service Values</h2>
    <!-- .card.service items -->
  </section>

  <section class="block">
    <h2 class="section">Added Values</h2>
    <!-- .card.added items -->
  </section>

  <section class="block">
    <h2 class="section">Summary</h2>
    <div class="row"><span class="k">Total values</span>[XX]</div>
    <div class="row"><span class="k">Top 5 strongest</span>[list, cited by ID]</div>
  </section>

  <section class="block">
    <h2 class="section">Competitor snapshot</h2>
    <table>
      <tr><th>Value</th><th>[Comp A]</th><th>[Comp B]</th><th>[Comp C]</th><th>Unique?</th></tr>
      <tr><td>PV-01</td><td>✗</td><td>✗</td><td>?</td><td>no</td></tr>
      <!-- one row per value; unique = whole row ✗ -->
    </table>
  </section>
  <p class="printhint">🖨 Print / Save as PDF — press <kbd>Ctrl</kbd>+<kbd>P</kbd> (<kbd>⌘</kbd>+<kbd>P</kbd> on Mac)</p>
</div>
...
## Skill reference materials: competitor-analysis

### Reference: rules-competitor-analysis.md
...
## Skill reference materials: buyer-persona

### Reference: rules-buyer-persona.md

# Buyer Persona Rules — Detailed Reference

## Segment evaluation criteria

When choosing a segment, assess it together with the user:

- Is this segment growing?
- What condition is it in?
- Is all of the company's competition present there?
- Does the company have a strong value proposition for this segment?
- How long does the buying process take?
- What can go wrong? (risks, e.g. legal, seasonality)
- What do they buy, and at what average price?
- Can the company actually reach the people in this segment?
- How many companies are there in this segment on the market?

**At least one of the target segments should be growing.**

---

## The Pineapple rule — choosing segment breadth

Think of precision as a ladder: "pineapple" → "tropical fruit" → "fruit" → "food". Each step up is broader and vaguer; each step down is narrower and sharper.

**By default, suggest the broadest possible segment**, as long as that entire segment shares a problem for which the company has a strong value proposition.

Narrow the segment when:
- Conversion across the broad segment is too low
- The market is crowded and you need to stand out
- The company's values speak only to a narrow niche

Examples:
- OK: "B2B SaaS companies with 50–200 employees" — if the values address this entire segment
- Too narrow without reason: "HR-software vendors in a single city"
- Too broad: "All software companies" — if the values only address mid-market SaaS

**The level of precision should be no greater than necessary, but enough to build effective processes.**

---

## The difference: Problem vs Challenge

**Problem (hurts TODAY):**
- A sudden failure, a process error, a financial loss
- Requires immediate action
- The customer is actively looking for a solution
- Examples: "We're losing 15% of leads because the CRM isn't configured", "The production line stands idle 3h a day due to outdated tooling", "A key salesperson left and took the relationships with them"

**Challenge (doesn't hurt today, but we have to do it):**
- Market shifts, regulations, expansion plans
- No urgency, but ignoring it leads to losses
- The customer knows they should act, but keeps putting it off
- Examples: "We have to enter a new export market within 2 years", "ESG regulations will force process changes", "The competition is automating sales and we haven't yet"

---

## The non-obviousness rule for problems and challenges

Problems and challenges must NOT be only the obvious ones. "The CEO wants sales growth": everyone knows that, so everyone has already exploited it.

Look for problems:
- That no one in the industry targets the way the company plans to
- That are specific to the segment (not general-business)
- That stem from operational realities, not from wishful thinking

**Bad examples (obvious: everyone already says this):**
- "Wants to increase revenue"
- "Looking for savings"
- "Needs better quality"
- "Wants to grow faster"
- "Needs more leads"
- "Wants to cut costs"
- "Looking to improve efficiency"
- "Needs to stay competitive"
- "Wants happier customers"
- "Needs to be more innovative"

**Good examples (non-obvious: specific, operational, measurable):**
- "Loses orders because there's no quoting system, and salespeople spend 2h manually calculating each offer"
- "Turnover in the purchasing department means supplier knowledge is lost every six months"
- "The board requires sales reports, but the data is spread across 4 different Excel files"
- "Every new hire takes 3 months to ramp because all the process knowledge lives in one senior employee's head"
- "Production schedules are replanned by hand each morning, so a single rush order throws off the whole week"
- "Field technicians fill in paper forms, so invoicing lags 2–3 weeks behind the work actually done"
- "Marketing and sales argue over lead quality because no one agrees on what 'qualified' means"
- "The warehouse counts stock once a quarter, so they only discover shortages when an order can't ship"
- "Customer complaints come in by phone, email, and chat, and nothing gets logged, so the same issue recurs unnoticed"
- "Each branch uses its own pricing spreadsheet, so the same customer gets two different quotes"
- "Compliance reports are assembled manually before every audit, eating a full week of the finance team's time"
- "Returns are processed without root-cause tracking, so a recurring defect keeps shipping for months"

---

## Questions for extracting problems and challenges

### About problems (what hurts today)
- What is the biggest frustration in this person's daily work?
- Where do they waste time on things that should work automatically?
- What keeps them awake at night thinking about work?
- What errors or losses recur regularly?
- What would happen if they changed nothing over the next 12 months?

### About challenges (what they have to do)
- What market changes are forcing action?
- What goals has the board set for this year that require new tools or processes?
- What regulations or customer requirements are forcing changes?
- Where is the competition already ahead?

### About the personal trigger
- What has to happen for this person to start ACTIVELY looking for a solution?
- What situation makes them say "enough, I have to change this"?
- Is it a one-time event (e.g. losing a customer) or a growing problem?

### About objections (what blocks the purchase)
- What is this person afraid of with a purchase like this?
- What might they say to delay the decision?
- What bad experiences from the past might shape the decision?
- Who in the organization can block the purchase, and why?

### Probing
- How much does it cost the company per year? (turn the problem into money)
...
Based on the problems and values you've collected, generate 3-5 objections per person. Each objection should have TWO variants:
- **Raw** — the way the customer actually says it (short, blunt): "Too expensive", "Not now", "I have to talk to my boss"
- **Expanded** — what the customer really means underneath: "I don't see how this will pay off given our budget"

### Raw objections (most common patterns)
- "Too expensive" / "We don't have the budget"
- "Not now" / "Maybe next quarter"
- "I have to check with someone" / "I don't decide alone"
- "We already tried it and it didn't work"
- "What if it doesn't work for us?"
- "We have more important priorities"
- "Our current supplier is OK"
- "It's too big a change"

### Expanded patterns per person type

**Person managing the company:**
- "We don't have the budget for this" -> Afraid to tie up cash without certainty of return
- "How can we be sure it will work for us?" -> Had bad experiences with previous suppliers
- "We have more important priorities" -> Doesn't yet see the scale of the problem

**Operational person / team manager:**
- "The rollout will paralyze our work" -> Afraid of transitional chaos
- "The team won't adapt" -> Knows people are resistant to change
- "The previous supplier promised the same thing" -> Lost trust in this type of solution

**Technical person / user:**
- "It doesn't integrate with our system" -> Afraid of extra work
- "I want to see it in action" -> Won't buy something they haven't tested
- "The specification doesn't meet the requirements" -> Looking for a reason to stick with the current solution

After generating them, ALWAYS validate with the user.

---

## Matching values to people

From the PSO (Problem · Solution · Outcome) list, assign values to people using this rule: **the same value can go to different people, but with a different emphasis (a different problem of that person).**

Matching guidelines:
- Person managing finances -> values affecting: cashflow, ROI, financial risk, cost of inaction
- Person managing operations -> values affecting: performance, time, reliability, simplicity
- Person managing the team -> values affecting: turnover, onboarding, competencies, motivation
- Technical person -> product values: parameters, certifications, compatibility, durability
- Purchasing person -> service values: payment terms, logistics, minimum order, warranty

Don't assign all values to all people. Pick the 3-7 strongest per person.

Cite each matched value by its ID (e.g. `PV-03`) so the persona stays linked to the value list.

---

## Output file format

### File 1: `buyer-persona.md` (Markdown)

```markdown
# Buyer Persona — [Company name]
Date: [date]
Model: Ananas-Agency Buyer Persona

## Persona 1: [Segment name]
...
- **Segment condition:** [growing/stagnant/declining]
- **Buying process length:** [short/medium/long]
- **Purchase trigger:** [what starts the process]

### Justification for choosing the segment
[Why this segment — what strong values the company has for it]

### People involved in the purchase

#### Person 1: [Role — e.g. "Manages sales"]
- **Role in the buying process:** [e.g. initiates the purchase, approves the budget]
- **Personal trigger:** [what has to happen for this person to start looking for a solution]
- **Problems (hurts today):**
  - [problem 1]
  - [problem 2]
- **Challenges (has to do):**
  - [challenge 1]
  - [challenge 2]
- **Objections:**
  - [objection 1]
...
- **Matched value propositions:**
  - PV-03 — [why this person]
  - SV-02 — [why this person]

[further people in the same format]

---

## Persona 2: [Segment name]
[same format]

---

## Recommendations for next steps
- Validate the persona through experiments on real customers (min. 2-3 experiments per persona)
- Test: whether the segment exists, whether the problems are real, whether the values resonate
- Methods: customer interviews, prospecting campaign, landing page test
```

### File 2: `buyer-persona.html` (styled, share-ready)

A single **self-contained** `.html` file (all CSS inline in one `<style>` block, **no external assets and no JavaScript**), so it opens in any browser, prints cleanly to PDF, and can be emailed as one file. Render the **same content** as the Markdown version. Keep the `<style>` block **identical to the shared design system** used across this suite (full CSS reproduced below).

- One `<section class="block">` per persona; the segment facts as `.row`s, the justification as a `<blockquote>`.
- One `.card` per person; Problems / Challenges / Objections as `<ul class="clean">` lists.
- Render each matched value as an `.id` chip (PV-/SV-/AV-) followed by the reason.
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>Buyer Persona — [Company name]</title>
<style>
:root{--page:#f5f5f7;--paper:#ffffff;--ink:#111111;--soft:#5b5852;--line:#e2e2e7;
--brand:#d99a2b;--brand-deep:#946618;--band:#0b0b0a;--band-ink:#b8b2a4}
*{box-sizing:border-box}
...
<div class="brandband">
  <div class="bwrap">
    <a class="pkgname" href="https://b2b-gtm-suite.ananas-agency.com/?utm_source=ananas-sales-skills&amp;utm_medium=deliverable&amp;utm_campaign=b2b-gtm-suite&amp;utm_content=buyer-persona" target="_blank" rel="noopener">B2B Go-to-Market Suite</a>
    <a class="brandlink" href="https://ananas-agency.com/?utm_source=ananas-sales-skills&amp;utm_medium=deliverable&amp;utm_campaign=b2b-gtm-suite&amp;utm_content=buyer-persona" target="_blank" rel="noopener">
      <span class="byline">by</span>
      <img class="brandlogo" src="https://ananas-agency.com/wp-content/uploads/2025/05/ananas-agency-logo-no-background-for-black.png" alt="Ananas Agency">
    </a>
  </div>
...
<div class="wrap">
  <header class="doc">
    <h1>Buyer Persona — [Company name]</h1>
    <div class="meta"><b>Date:</b> [date] &nbsp;·&nbsp; <b>Model:</b> Ananas-Agency Buyer Persona</div>
  </header>

  <section class="block">
    <h2 class="section">Persona 1 — [Segment name]</h2>
    <div class="row"><span class="k">Industry</span>[industry, sub-industry]</div>
    <div class="row"><span class="k">Company size</span>[headcount, revenue]</div>
    <div class="row"><span class="k">Location</span>[region/country]</div>
    <div class="row"><span class="k">Segment condition</span>[growing/stagnant/declining]</div>
    <div class="row"><span class="k">Buying process length</span>[short/medium/long]</div>
    <div class="row"><span class="k">Purchase trigger</span>[what starts the process]</div>
    <blockquote>[Justification for choosing the segment]</blockquote>

    <article class="card">
      <h3>[Role — e.g. "Manages sales"]</h3>
      <div class="row"><span class="k">Role in buying process</span>[e.g. initiates, approves budget]</div>
      <div class="row"><span class="k">Personal trigger</span>[what has to happen]</div>
      <div class="row"><span class="k">Problems</span></div>
      <ul class="clean"><li>[problem 1]</li><li>[problem 2]</li></ul>
      <div class="row"><span class="k">Challenges</span></div>
      <ul class="clean"><li>[challenge 1]</li></ul>
      <div class="row"><span class="k">Objections</span></div>
      <ul class="clean"><li>[objection 1]</li></ul>
      <div class="row"><span class="k">Matched values</span>
        <span class="id">PV-03</span> [why] &nbsp; <span class="id">SV-02</span> [why]</div>
    </article>
    <!-- further people as more .card blocks -->
  </section>

  <!-- further personas as more section.block -->

  <section class="block">
    <h2 class="section">Recommendations for next steps</h2>
    <ul class="clean">
      <li>Validate the persona through experiments on real customers (min. 2-3 per persona)</li>
      <li>Test: whether the segment exists, whether the problems are real, whether the values resonate</li>
      <li>Methods: customer interviews, prospecting campaign, landing page test</li>
    </ul>
  </section>
  <p class="printhint">🖨 Print / Save as PDF — press <kbd>Ctrl</kbd>+<kbd>P</kbd> (<kbd>⌘</kbd>+<kbd>P</kbd> on Mac)</p>
</div>
...
## Persona validation methods (to recommend to the user)

A persona is a hypothesis: it has to be validated. Experiment methods:

1. Phone interview with current customers from this segment
2. Interview with customers reached e.g. on LinkedIn (deliberately, as research)
3. A value proposition sheet in PDF — sent to customers for their feedback
4. Prospecting campaign (email/phone) — testing the messaging
5. Landing page test with paid advertising — does the segment respond?
6. Analysis of Google search trends

**For key hypotheses — min. 2-3 different experiments.** Don't rely on just one.
...
# 4. Experiments Validating the Buyer Persona

**Skill ID:** `persona-experiments`
...
## Skill reference materials: persona-experiments

### Reference: rules-experiments.md
...
# 5. B2B Segment Buying Process

**Skill ID:** `buying-process`
...
## Skill reference materials: buying-process

### Reference: rules-buying-processes.md
...
# 6. Missing Value Propositions — Gap Analysis

**Skill ID:** `missing-value-propositions`
...
## Skill reference materials: missing-value-propositions

### Reference: rules-missing-pso.md
...
**Skill ID:** `messaging-positioning`
...
## Skill reference materials: messaging-positioning

### Reference: rules-messaging.md
